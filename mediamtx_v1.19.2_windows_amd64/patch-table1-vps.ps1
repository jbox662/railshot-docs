...
$newTable1 = @"
  table1:
    runOnDemand: ffmpeg -hide_banner -loglevel warning -rtsp_transport tcp -i rtsp://admin:decoder1@140.106.76.67:8554/h264Preview_01_sub -c copy -f rtsp -rtsp_transport tcp rtsp://127.0.0.1:`$RTSP_PORT/`$MTX_PATH
